        ...
        */
        ...
        function addRiverMarkers() {
            ...
            for (i=0; i<riverSections.length; i++) {
                ...
                var contentString = "<div><p>You are only allowed to exercise with members of your household during the pandemic.</p><h4 style='padding-left: 30px;'>" + riverSection + "</h4>" +
