        ...
        */
        ...
        function addRiverMarkers() {
            ...
            for (i=0; i<riverSections.length; i++) {
                ...
                var contentString = "<div><p>🦠 Be considerate, be conservative. Stay local, paddle within limits, meet only people from 1 other household a day but stay 2m apart. 😷</p><h4 style='padding-left: 30px;'>" + riverSection + "</h4>" +
