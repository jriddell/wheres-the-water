        ...
        */
        ...
        function addRiverMarkers() {
            ...
            for (i=0; i<riverSections.length; i++) {
                ...
                var contentString = "<div><p style='background-color: greenyellow'>🦠 No car sharing, groups of 2 households &amp; 6 people max, stay 2m apart, practice kit hygiene. 😷</p><h4 style='padding-left: 30px;'>" + riverSection + "</h4>" +
