...
<?php
    ...
    /*simpler header used in the iframe page for new canoescotland site */
    public function iframeHeaderStuff() {
?>
<style>
.js-tab-top {
    padding: 1em;
    ...
    <script type="text/javascript">
        ...
        */
        ...
        function linksContent2(riverSection) {
            ...
            linksContent += "<span class='desktop'><a target='_blank' rel='noopener' href='http://apps.sepa.org.uk/waterlevels/default.aspx?sd=t&lc="+riverSection['gauge_location_code']+"'><img width='16' height='16' title='SEPA gauge link' src='/wheres-the-water/pics/graph-icon.png'/> SEPA Gauge: "+riverSection['gauge_name']+"</a><br /></span>";
