...
class RiverSections {
    ...
    */
    ...
    private function trForRiver($jsonid, $riverSection, $sepaGaugesData, $riverReadingData) {
        ...
        //$linkContent .= "&nbsp; <a target='_blank' rel='noopener' href='/wheres-the-water/charts/${filename}-yearly.png'><img title='Weekly Chart' src='/wheres-the-water/pics/chart-yearly.png' /></a>";
