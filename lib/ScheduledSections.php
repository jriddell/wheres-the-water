...
[
    {
        ...
        "latitude": "57.0759",
        "grade": "2-3",
        "info_link": "http://www.paddlescotland.org.uk/tummel-releases",
    ...
    private function trForRiver($jsonid, $riverSection, $sepaGaugesData, $riverReadingData, $forecastHtml) {
        ...
        */
        ...
        if (!empty($riverSection['sca_guidebook_no'])) {
            $linkContent .= "<img width='16' height='16' title='Paddle Scotland WW Guidebook number' src='/wheres-the-water/pics/paddle-scotland-icon.png' /> Paddle Scotland Guidebook No ".$riverSection['sca_guidebook_no']."<br />";
        }
        ...
        */
        ...
        if ($chartLink != false) {
            $linkContent .= "<span class='desktop'><a target='_blank' rel='noopener' href='".$this->riverZoneStations->link($riverSection)."'><img width='16' height='16' title='Webcam' src='/wheres-the-water/pics/chart-yearly.png' /> Rivermap Graph`</a><br /></span>";
            $linkContent .= "<span class='mobile'><a target='_blank' rel='noopener' href='".$this->riverZoneStations->link($riverSection, true)."'><img width='16' height='16' title='Webcam' src='/wheres-the-water/pics/chart-yearly.png' /> Rivermap Graph</a><br /></span>";
        }
        /* Render the picture */
