...
class GrabSepaGauges {
    ...
    function doGrab() {
        if (!file_exists($this->sepaFile) || time()-filemtime($this->sepaFile) > self::SEPA_DOWNLOAD_PERIOD) {
            ...
            $this->verifyCsvData() || die('<a href="https://www.sepa.org.uk/help/system-temporarily-unavailable">SEPA data invalid</a>, cybers have attacked.<br /> <img src="https://i.redd.it/8falj3k93rg21.jpg">'); // CSV data did not verify
