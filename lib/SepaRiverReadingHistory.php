...
class SepaRiverReadingHistory {
    ...
    public function writeChart($river, $daysHistory, $chartName) {
        ...
        $myPicture->drawFromPNG(700, 10, "pics/paddle-scotland-icon.png");
        ...
        $myPicture->drawText(10,10,$river['name'] . " ($chartName - up to ".end($timeLabels).")",array("FontSize"=>20,"Align"=>TEXT_ALIGN_TOPLEFT));
