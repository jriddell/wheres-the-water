...
if(document.getElementById && document.createTextNode) {
	...
	*/
	...
	<!-- old output Clyde @ Hazelbank
	var point212 = new GLatLng(55.678,-3.83818);
        markerOptions = { icon:VERY_HIGHIcon };
        var marker212 = new GMarker(point212, markerOptions);
        GEvent.addListener(marker212, "mouseover", function() {
        	showSectionInfo("Clyde", "VERY_HIGH", "04/10/2017 14:00", "0.819", "RISING" );
        	showConversionInfo("VERY_HIGH", "0.4","0.5", "0.6", "0.7", "0.8", "0.9");
		});
	GEvent.addListener(marker212, "click", function() {  showPicWin('http://apps.sepa.org.uk/waterlevels/default.aspx?sd=t&lc=133094') });
...
<?php
$api_contents = file_get_contents('http://api.rainchasers.com/v1/river/?q=56.659406,-4.011214');
$json = json_decode($api_contents, true);

//print $json['data'];
foreach($json['data'] as $river_data) {
    print "<ul>";
    print "<li>Name: " . $river_data['river'] . "</li>";
    print "<li>Lat: " . $river_data['putin']['lat'] . "</li>";
    print "<li>Long: " . $river_data['putin']['lng'] . "</li>";
    print "</ul>";
}
