...
if [ -s /home/jr/tmp/river-sections.json ]; then
    python -mjson.tool /home/jr/tmp/river-sections.json > /home/jr/www/www.andyjacksonfund.org.uk/wheres-the-water/data/river-sections.json
